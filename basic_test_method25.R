################# Basic test on 25 different series of fixed size 200 #########################
...
saveRDS(vs,file='basic_test_method_series_21') # change file name!!!
...
saveRDS(results55,file='basic_test_method_results_21') # change file name!!!
